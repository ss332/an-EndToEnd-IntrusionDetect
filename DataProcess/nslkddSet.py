...
def nsl_set():
    ...
    # 读取数据集
    nsl_train = pd.read_csv("./data/NSL_KDD99/KDDTrain+2.csv", header=None, names=col_names)
    nsl_test = pd.read_csv("./data/NSL_KDD99/KDDTest+2.csv", header=None, names=col_names)
